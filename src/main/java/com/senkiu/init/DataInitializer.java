...
public class DataInitializer implements CommandLineRunner {
    ...
    public DataInitializer(
        ...
        EstadoOrganizacionRepository estadoOrganizacionRepository,
    ...
    private void crearEstadoUsuarioSiNoExiste(String nombre) {
        ...
        estadoUsuarioRepository.findByNombre(nombre)
            .ifPresentOrElse(
                estado -> {},
                () -> {
    ...
    private void crearEstadoOrganizacionSiNoExiste(String nombre) {
        ...
        estadoOrganizacionRepository.findByNombre(nombre)
            .ifPresentOrElse(
                estado -> {},
                () -> {
    ...
    private void crearCategoria(String nombre, String tipo) {
        ...
        categoriaRepository.findByNombreAndTipo(nombre, tipo)
            .ifPresentOrElse(
                c -> {},
                () -> {
