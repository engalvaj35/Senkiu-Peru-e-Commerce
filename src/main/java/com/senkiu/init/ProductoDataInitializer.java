...
public class ProductoDataInitializer implements CommandLineRunner {
	...
	public ProductoDataInitializer(EstadoPublicacionRepository estadoRepository,
	...
	private void crearEstadoPublicacion(String nombre) {
		...
		estadoRepository.findByNombre(nombre).ifPresentOrElse(e -> {
		}, () -> {
	...
	private void crearCategoriaProducto(String nombre) {
		categoriaRepository.findByNombreAndTipo(nombre, "PRODUCTO").ifPresentOrElse(c -> {
		}, () -> {
