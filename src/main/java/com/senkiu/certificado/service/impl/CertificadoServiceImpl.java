...
public class CertificadoServiceImpl implements CertificadoService {
	...
	public CertificadoServiceImpl(CertificadoRepository repo, StorageService storageService) {
		this.repo = repo;
		this.storageService = storageService;
	}

	@Override
	public void guardarCertificadoSolicitud(SolicitudOrganizacion solicitud, String nombre, MultipartFile archivo) {
