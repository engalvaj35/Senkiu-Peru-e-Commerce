...
public class ProgramaSocial {
    ...
    @Column(name = "objetivo_monto", nullable = false, precision = 10, scale
    = 2)
    ...
    public ProgramaSocial(Long id, Ong ong, Categoria categoria, String
    nombre, BigDecimal objetivoMonto,
    BigDecimal montoActual, String descripcion, EstadoPublicacion
    estado) {
    super();
    this.id = id;
    this.ong = ong;
