...
public class ProgramaSocialDTO {
 ...
 public ProgramaSocialDTO(Long id, String nombre, String descripcion,
String categoriaNombre,
 BigDecimal objetivoMonto, BigDecimal montoActual, BigDecimal
porcentajeAvance, String estadoNombre) {
 super();
 this.id = id;
 this.nombre = nombre;
