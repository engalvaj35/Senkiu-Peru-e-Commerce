...
public class UsuarioViewController {
    ...
    public String verPerfil(
        ...
        model.addAttribute(
                "perfil",
                service.obtenerPerfil(userDetails.getId())
        );

        model.addAttribute(
                "ordenes",
                ordenService.listarPorUsuario(userDetails.getId())
        );
        ...
        model.addAttribute(
                "suscripcion",
                suscripcionService.obtenerPorUsuario(
                        userDetails.getId()
                )
        );
        ...
        model.addAttribute(
                "donaciones",
                donacionService.listarPorUsuario(
                        userDetails.getId()
                )
        );
        ...
        model.addAttribute(
                "tickets",
                ticketService.obtenerMisTickets(userDetails.getId())
        );

        model.addAttribute(
                "saldo",
                walletService.obtenerSaldo(userDetails.getId())
        );
    ...
    public String actualizarPerfil(
            @Valid @ModelAttribute("perfil") UsuarioPerfilRequest request,
                ...
                model.addAttribute(
                        "suscripcion",
                        suscripcionService.obtenerPorUsuario(userDetails.getId())
                );

                model.addAttribute(
                        "donaciones",
                        donacionService.listarPorUsuario(userDetails.getId())
                );
