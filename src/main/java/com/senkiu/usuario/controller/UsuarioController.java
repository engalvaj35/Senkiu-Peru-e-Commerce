...
public class UsuarioController {
	...
	public UsuarioPerfilResponse completarPerfil(@Valid @RequestBody UsuarioPerfilRequest request,
		...
		UsuarioPerfilResponse response = service.completarPerfil(userDetails.getId(), request);
	...
	@GetMapping("/perfil")
	@PreAuthorize("isAuthenticated()")
	public UsuarioPerfilResponse obtenerPerfil(@AuthenticationPrincipal CustomUserDetails userDetails) {

		return service.obtenerPerfil(userDetails.getId());
	}
}