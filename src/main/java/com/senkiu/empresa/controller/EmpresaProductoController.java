...
public class EmpresaProductoController {
	...
	public EmpresaProductoController(SolicitudProductoService solicitudService, EmpresaRepository empresaRepository) {
	...
	public void crearSolicitudProducto(
			...
			@Valid @ModelAttribute SolicitudProductoRequest request,

			@AuthenticationPrincipal CustomUserDetails user,

			@RequestParam("archivo") MultipartFile archivo) {

		Empresa empresa = empresaRepository.findByUsuarioId(user.getId())
				.orElseThrow(() -> new RuntimeException("Empresa no encontrada"));

		solicitudService.crearSolicitud(empresa.getId(), request, archivo);
	}
}