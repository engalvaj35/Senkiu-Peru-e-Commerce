...
public class AdminServiceImpl implements AdminService {
	...
	private static final Set<String> ROLES_VALIDOS = Set.of("ROLE_USER", "ROLE_ADMIN", "ROLE_ONG", "ROLE_EMPRESA");
	...
	public AdminServiceImpl(UsuarioRepository usuarioRepository, EstadoUsuarioRepository estadoRepository) {
	...
	public void cambiarRol(Long id, String rol) {
		...
		Usuario user = usuarioRepository.findById(id).orElseThrow(() -> new RuntimeException("Usuario no existe"));
	...
	public void suspenderUsuario(Long id) {
		...
		EstadoUsuario estado = estadoRepository.findByNombre("INACTIVO")
