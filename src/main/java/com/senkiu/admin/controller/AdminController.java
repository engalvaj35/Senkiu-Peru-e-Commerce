...
public class AdminController {
    ...
    public String dashboard(Model model) {
        ...
        model.addAttribute("cuentasEmpresa",
                empresaService.findAll()
                        .stream()
                        .flatMap(e -> cuentaBancariaService.listarPorEmpresa(e.getId()).stream())
                        .toList()
        );

        model.addAttribute("cuentasOng",
                ongService.findAll()
                        .stream()
                        .flatMap(o -> cuentaBancariaService.listarPorOng(o.getId()).stream())
                        .toList()
        );
