...
public class AdminApiController {
	...
	public AdminApiController(AdminService adminService, SolicitudOrganizacionService solicitudService,
			EmpresaService empresaService, OngService ongService, SolicitudProductoService solicitudProductoService,
			SolicitudProgramaService solicitudProgramaService, TicketService ticketService) {
